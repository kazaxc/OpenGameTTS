...
Early stages work in progess but it is fully functional, the code is just not very clean and the project layout needs some work along with a few extra features. Major [refactor](https://github.com/kazaxc/OpenGameTTS/tree/avalonia-refactor) currently underway, check [here](https://github.com/kazaxc/OpenGameTTS/milestones) for the roadmap.
